...
cp -rf ~/SDR/galaxy-workflow/tools/* /var/www/html/galaxy/tools/sdr
...
cp -f ~/SDR/galaxy-workflow/config/tool_conf.xml /var/www/html/galaxy/config/tool_conf.xml
cp -f ~/SDR/galaxy-workflow/config/sdr_tool_conf.xml /var/www/html/galaxy/config/sdr_tool_conf.xml
cp -f ~/SDR/galaxy-workflow/config/job_conf.xml /var/www/html/galaxy/config/job_conf.xml
cp -f ~/SDR/galaxy-workflow/config/local_env.sh /var/www/html/galaxy/config/local_env.sh
cp -f ~/SDR/galaxy-workflow/config/opends-schema.json /var/www/html/galaxy/config/opends-schema.json

#copy main server config
cp -f ~/SDR/galaxy-workflow/config/galaxy.yml /var/www/html/galaxy/config/galaxy.yml

#copy data type files
cp -f ~/SDR/galaxy-workflow/config/datatypes_conf.xml /var/www/html/galaxy/config/datatypes_conf.xml

#copy visualisations
strEcho "Updating visualisations"
cp -rf ~/SDR/galaxy-workflow/visualisations/roi /var/www/html/galaxy/config/plugins/visualizations

#copy static content
strEcho "Updating statics"
cp -rf ~/SDR/galaxy-workflow/static/* /var/www/html/galaxy/static/
